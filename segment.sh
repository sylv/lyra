...
ffmpeg -y -i $1 -copyts -sn -an -c:0 copy -start_at_zero -avoid_negative_ts disabled \
  -f hls -hls_flags +split_by_time+temp_file -hls_segment_type fmp4 -hls_time 10 -hls_list_size 0 -hls_segment_filename segments/seg-%d.ts -start_number 333 segments/index.m3u8