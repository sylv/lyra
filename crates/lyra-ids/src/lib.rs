...
#[cfg(test)]
mod tests {
    use super::{generate_hashid, generate_prefixed_hashid, generate_prefixed_ulid};
    ...
    #[test]
    fn prefixed_ulids_keep_the_requested_prefix() {
        let id = generate_prefixed_ulid("ps");
        assert_eq!(id.len(), 29);
