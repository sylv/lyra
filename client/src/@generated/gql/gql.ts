...
const documents: Documents = {
    ...
    "\n\tfragment WatchSessionSummary on WatchSession {\n\t\tid\n\t\tnodeId\n\t\tfileId\n\t\tmode\n\t\tintent\n\t\teffectiveState\n\t\tcurrentPositionMs\n\t\tbasePositionMs\n\t\tbaseTimeMs\n\t\trevision\n\t\tplayers {\n\t\t\tid\n\t\t\tuserId\n\t\t\tuser {\n\t\t\t\tid\n\t\t\t\tusername\n\t\t\t}\n\t\t\tisBuffering\n\t\t\tisInactive\n\t\t\tcanRemove\n\t\t}\n\t}\n": types.WatchSessionSummaryFragmentDoc,
    "\n\tfragment WatchSessionBeaconFragment on WatchSessionBeacon {\n\t\tsessionId\n\t\tnodeId\n\t\tfileId\n\t\tmode\n\t\tintent\n\t\teffectiveState\n\t\tbasePositionMs\n\t\tbaseTimeMs\n\t\trevision\n\t\tplayers {\n\t\t\tid\n\t\t\tuserId\n\t\t\tuser {\n\t\t\t\tid\n\t\t\t\tusername\n\t\t\t}\n\t\t\tisBuffering\n\t\t\tisInactive\n\t\t\tcanRemove\n\t\t}\n\t}\n": types.WatchSessionBeaconFragmentFragmentDoc,
    "\n\tquery WatchSessionViewer {\n\t\tviewer {\n\t\t\tid\n\t\t\tpermissions\n\t\t}\n\t}\n": types.WatchSessionViewerDocument,
