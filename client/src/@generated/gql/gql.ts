...
type Documents = {
    ...
    "\n  fragment PlayerNavigation on Node {\n    id\n    ...PlayerItemCard\n  }\n": typeof types.PlayerNavigationFragmentDoc,
    "\n  fragment PlayerMetadata on Node {\n    id\n    libraryId\n    root {\n      id\n      libraryId\n      properties {\n        displayName\n      }\n    }\n    properties {\n      displayName\n      seasonNumber\n      episodeNumber\n      firstAired\n      lastAired\n    }\n    ...GetPathForNode\n  }\n": typeof types.PlayerMetadataFragmentDoc,
...
const documents: Documents = {
    ...
    "\n  fragment PlayerNavigation on Node {\n    id\n    ...PlayerItemCard\n  }\n": types.PlayerNavigationFragmentDoc,
    "\n  fragment PlayerMetadata on Node {\n    id\n    libraryId\n    root {\n      id\n      libraryId\n      properties {\n        displayName\n      }\n    }\n    properties {\n      displayName\n      seasonNumber\n      episodeNumber\n      firstAired\n      lastAired\n    }\n    ...GetPathForNode\n  }\n": types.PlayerMetadataFragmentDoc,
    "\n  fragment PlayerTimelinePreviewSheet on TimelinePreviewSheet {\n    positionMs\n    endMs\n    sheetIntervalMs\n    sheetGapSize\n    asset {\n      id\n      signedUrl\n      width\n      height\n    }\n  }\n": types.PlayerTimelinePreviewSheetFragmentDoc,
    "\n  mutation SetPreferredAudio($language: String, $disposition: TrackDispositionPreference) {\n    setPreferredAudio(language: $language, disposition: $disposition) {\n      id\n      preferredAudioLanguage\n      preferredAudioDisposition\n    }\n  }\n": types.SetPreferredAudioDocument,
    "\n  mutation DisabledSubtitlesHint($input: DisabledSubtitlesHintInput!) {\n    disabledSubtitlesHint(input: $input)\n  }\n": types.DisabledSubtitlesHintDocument,
    "\n  fragment PlayerSkipIntro on Node {\n    id\n    defaultFile {\n      segments {\n        kind\n        startMs\n        endMs\n      }\n      probe {\n        runtimeMinutes\n      }\n    }\n    watchProgress {\n      id\n      progressPercent\n      completed\n    }\n  }\n": types.PlayerSkipIntroFragmentDoc,
    "\n  mutation MintSubtitleUrl($input: SubtitleUrlInput!) {\n    mintSubtitleUrl(input: $input) {\n      url\n    }\n  }\n": types.MintSubtitleUrlDocument,
    "\n  fragment PlayerUpNext on Node {\n    id\n    defaultFile {\n      probe {\n        runtimeMinutes\n      }\n    }\n    watchProgress {\n      id\n      progressPercent\n      completed\n    }\n    nextPlayable {\n      id\n      ...PlayerItemCard\n    }\n  }\n": types.PlayerUpNextFragmentDoc,
    "\n  fragment WatchSessionBeaconFragment on WatchSessionBeacon {\n    sessionId\n    nodeId\n    fileId\n    mode\n    intent\n    effectiveState\n    basePositionMs\n    baseTimeMs\n    revision\n    players {\n      id\n      userId\n      displayUsername\n      isBuffering\n      isInactive\n      canRemove\n    }\n  }\n": types.WatchSessionBeaconFragmentFragmentDoc,
    "\n  mutation LeaveWatchSession($sessionId: String!, $playerId: String!) {\n    leaveWatchSession(sessionId: $sessionId, playerId: $playerId)\n  }\n": types.LeaveWatchSessionDocument,
    "\n  mutation WatchSessionHeartbeat($input: WatchSessionHeartbeatInput!) {\n    watchSessionHeartbeat(input: $input) {\n      ...WatchSessionBeaconFragment\n    }\n  }\n": types.WatchSessionHeartbeatDocument,
    "\n  mutation WatchSessionAction($input: WatchSessionActionInput!) {\n    watchSessionAction(input: $input) {\n      ...WatchSessionBeaconFragment\n    }\n  }\n": types.WatchSessionActionDocument,
    "\n  subscription WatchSessionBeacons($sessionId: String!, $playerId: String!) {\n    watchSessionBeacons(sessionId: $sessionId, playerId: $playerId) {\n      ...WatchSessionBeaconFragment\n    }\n  }\n": types.WatchSessionBeaconsDocument,
    "\n  mutation MintPlaybackUrl($input: PlaybackUrlInput!) {\n    mintPlaybackUrl(input: $input) {\n      url\n      packagerId\n    }\n  }\n": types.MintPlaybackUrlDocument,
    "\n  mutation UpdateWatchState($fileId: String!, $progressPercent: Float!) {\n    updateWatchProgress(fileId: $fileId, progressPercent: $progressPercent) {\n      progressPercent\n      updatedAt\n    }\n  }\n": types.UpdateWatchStateDocument,
    "\n  query ItemPlayback($itemId: String!, $languageHints: [String!]) {\n    node(nodeId: $itemId) {\n      id\n      ...PlayerMetadata\n      ...PlayerSkipIntro\n      ...PlayerUpNext\n      defaultFile {\n        id\n        probe {\n          runtimeMinutes\n        }\n        playbackOptions(languageHints: $languageHints) {\n          videoRenditions {\n            renditionId\n            displayName\n            displayInfo\n            codecTag\n            onDemand\n          }\n          audioTracks {\n            streamIndex\n            displayName\n            language\n            recommended\n            renditions {\n              renditionId\n              codecName\n              bitrate\n              channels\n              sampleRate\n              codecTag\n              onDemand\n            }\n          }\n          subtitleTracks {\n            id\n            streamIndex\n            displayName\n            languageBcp47\n            flags\n            autoselect\n            renditions {\n              id\n              codecName\n              type\n              displayInfo\n              onDemand\n            }\n          }\n        }\n        timelinePreview {\n          ...PlayerTimelinePreviewSheet\n        }\n      }\n      previousPlayable {\n        id\n        ...PlayerNavigation\n      }\n      nextPlayable {\n        id\n        ...PlayerNavigation\n      }\n      watchProgress {\n        id\n        progressPercent\n        completed\n        updatedAt\n      }\n    }\n  }\n": types.ItemPlaybackDocument,
    "\n  query GetWatchSession($sessionId: String!) {\n    watchSession(sessionId: $sessionId) {\n      id\n      nodeId\n    }\n  }\n": types.GetWatchSessionDocument,
