...
export type GetLibrariesQuery = { libraries: Array<{ __typename: 'Library', id: string, name: string, path: string }> };
...
export type CreateLibraryMutation = { createLibrary: { __typename: 'Library', id: string, name: string, path: string } };
