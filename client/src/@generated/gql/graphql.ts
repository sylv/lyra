...
export type ItemPlaybackQuery = { node: (
    { __typename: 'Node', id: string, libraryId: string, kind: NodeKind, properties: { __typename: 'NodeProperties', displayName: string, seasonNumber: number | null, episodeNumber: number | null, firstAired: number | null, lastAired: number | null }, root: { __typename: 'Node', id: string, libraryId: string, properties: { __typename: 'NodeProperties', displayName: string } } | null, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean, updatedAt: number } | null, defaultFile: { __typename: 'File', id: string, probe: { __typename: 'FileProbe', runtimeMinutes: number | null } | null, playbackOptions: { __typename: 'PlaybackOptions', videoRenditions: Array<{ __typename: 'VideoRenditionOption', renditionId: string, displayName: string, displayInfo: string, codecTag: string, onDemand: boolean }>, audioTracks: Array<{ __typename: 'AudioTrackOption', streamIndex: number, displayName: string, language: string | null, recommended: boolean, renditions: Array<{ __typename: 'AudioRenditionOption', renditionId: string, codecName: string, bitrate: number | null, channels: number | null, sampleRate: number | null, codecTag: string, onDemand: boolean }> }> }, subtitles: Array<{ __typename: 'SubtitleTrack', id: string, streamIndex: number, displayName: string, languageBcp47: string | null, flags: Array<string>, autoselect: boolean, renditions: Array<{ __typename: 'SubtitleRendition', id: string, codecName: string, type: SubtitleRenditionType, displayInfo: string, onDemand: boolean }> }>, segments: Array<{ __typename: 'FileSegment', kind: FileSegmentKind, startMs: number, endMs: number }>, timelinePreview: Array<(
        { __typename: 'TimelinePreviewSheet' }
