...
export type PlayerTimelinePreviewSheetFragment = { __typename: 'TimelinePreviewSheet', positionMs: number, endMs: number, sheetIntervalMs: number, sheetGapSize: number, asset: { __typename: 'Asset', id: string, width: number | null, height: number | null } } & { ' $fragmentName'?: 'PlayerTimelinePreviewSheetFragment' };
