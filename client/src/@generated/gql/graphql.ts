...
export type CollectionNodeCardFragment = (
  { __typename: 'Node', id: string, kind: NodeKind, libraryId: string, properties: { __typename: 'NodeProperties', displayName: string, description: string | null, seasonNumber: number | null, episodeNumber: number | null, firstAired: number | null, lastAired: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null, thumbnailImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null }, watchProgress: { __typename: 'WatchProgress', progressPercent: number, completed: boolean, updatedAt: number } | null, nextPlayable: { __typename: 'Node', id: string, watchProgress: { __typename: 'WatchProgress', progressPercent: number, completed: boolean, updatedAt: number } | null } | null }
...
export type CollectionShelfFragment = { __typename: 'Collection', id: string, name: string, nodeList: { __typename: 'NodeConnection', nodes: Array<(
      ...
      & { ' $fragmentRefs'?: { 'CollectionNodeCardFragment': CollectionNodeCardFragment } }
...
export type EpisodeCardFragment = (
  { __typename: 'Node', id: string, properties: { __typename: 'NodeProperties', displayName: string, description: string | null, seasonNumber: number | null, episodeNumber: number | null, firstAired: number | null, runtimeMinutes: number | null, thumbnailImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
...
export type NodePosterFragment = (
  { __typename: 'Node', id: string, kind: NodeKind, libraryId: string, unplayedCount: number, seasonCount: number, episodeCount: number, properties: { __typename: 'NodeProperties', displayName: string, firstAired: number | null, lastAired: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
...
export type SeasonCardFragment = (
  { __typename: 'Node', id: string, unplayedCount: number, episodeCount: number, properties: { __typename: 'NodeProperties', displayName: string, seasonNumber: number | null, firstAired: number | null, lastAired: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null, thumbnailImage: (
      { __typename: 'Asset' }
...
export type GetNodeByIdQuery = { node: (
    { __typename: 'Node', id: string, libraryId: string, kind: NodeKind, seasonNumber: number | null, episodeNumber: number | null, unplayedCount: number, episodeCount: number, parent: (
