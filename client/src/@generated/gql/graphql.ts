...
export type EpisodeCardFragment = (
  { __typename: 'Node', id: string, properties: { __typename: 'NodeProperties', displayName: string, description: string | null, seasonNumber: number | null, episodeNumber: number | null, releasedAt: number | null, runtimeMinutes: number | null, thumbnailImage: (
      { __typename: 'Asset' }
...
export type NodePosterFragment = (
  { __typename: 'Node', id: string, kind: NodeKind, libraryId: string, unplayedCount: number, seasonCount: number, episodeCount: number, properties: { __typename: 'NodeProperties', displayName: string, releasedAt: number | null, endedAt: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
...
export type SearchNodeResultFragment = (
  { __typename: 'Node', id: string, kind: NodeKind, libraryId: string, seasonCount: number, episodeCount: number, root: { __typename: 'Node', properties: { __typename: 'NodeProperties', displayName: string } } | null, properties: { __typename: 'NodeProperties', displayName: string, description: string | null, seasonNumber: number | null, episodeNumber: number | null, releasedAt: number | null, endedAt: number | null, runtimeMinutes: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null, thumbnailImage: (
      { __typename: 'Asset' }
...
export type SeasonCardFragment = (
  { __typename: 'Node', id: string, unplayedCount: number, episodeCount: number, properties: { __typename: 'NodeProperties', displayName: string, seasonNumber: number | null, releasedAt: number | null, endedAt: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null, thumbnailImage: (
      { __typename: 'Asset' }
...
export type GetNodeByIdQuery = { node: { __typename: 'Node', id: string, libraryId: string, kind: NodeKind, seasonNumber: number | null, episodeNumber: number | null, unplayedCount: number, episodeCount: number, parent: { __typename: 'Node', id: string, libraryId: string, properties: { __typename: 'NodeProperties', displayName: string } } | null, root: { __typename: 'Node', id: string, properties: { __typename: 'NodeProperties', displayName: string } } | null, children: Array<(
    ...
    )>, properties: { __typename: 'NodeProperties', displayName: string, releasedAt: number | null, endedAt: number | null, runtimeMinutes: number | null, description: string | null, posterImage: (
        { __typename: 'Asset' }
        & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
...
export type GetEpisodesQuery = { nodeList: { __typename: 'NodeConnection', edges: Array<{ __typename: 'NodeEdge', node: (
        { __typename: 'Node', id: string }
