...
export type Asset = {
  ...
  uncompressedSizeBytes: Maybe<Scalars['Int']['output']>;
  width: Maybe<Scalars['Int']['output']>;
};

export type AudioRenditionOption = {
  __typename: 'AudioRenditionOption';
  bitrate: Maybe<Scalars['Int']['output']>;
  channels: Maybe<Scalars['Int']['output']>;
  codecName: Scalars['String']['output'];
  codecTag: Scalars['String']['output'];
  onDemand: Scalars['Boolean']['output'];
  renditionId: Scalars['String']['output'];
  sampleRate: Maybe<Scalars['Int']['output']>;
};

export type AudioTrackOption = {
  __typename: 'AudioTrackOption';
...
export type DisabledSubtitlesHintInput = {
  fileId: Scalars['String']['input'];
  renditionId: Scalars['String']['input'];
...
export type FilePlaybackOptionsArgs = {
  languageHints?: InputMaybe<Array<Scalars['String']['input']>>;
};
...
export type Mutation = {
  ...
  addNodeToWatchlist: Scalars['Boolean']['output'];
  ...
  disabledSubtitlesHint: Scalars['Boolean']['output'];
  importWatchStates: ImportWatchStatesResult;
  leaveWatchSession: Scalars['Boolean']['output'];
  mintPlaybackUrl: PlaybackUrlPayload;
  mintSubtitleUrl: SubtitleUrlPayload;
  removeNodeFromWatchlist: Scalars['Boolean']['output'];
...
export type MutationAddNodeToWatchlistArgs = {
  nodeId: Scalars['String']['input'];
};
...
export type MutationDisabledSubtitlesHintArgs = {
...
export type MutationMintPlaybackUrlArgs = {
  input: PlaybackUrlInput;
};


export type MutationMintSubtitleUrlArgs = {
  input: SubtitleUrlInput;
};


export type MutationRemoveNodeFromWatchlistArgs = {
  nodeId: Scalars['String']['input'];
};
...
export type Node = {
  ...
  children: Array<Node>;
  createdAt: Scalars['Int']['output'];
  currentPlayable: Maybe<Node>;
  defaultFile: Maybe<File>;
  ...
  lastFingerprintVersion: Maybe<Scalars['Int']['output']>;
  libraryId: Scalars['String']['output'];
...
export type PlaybackOptions = {
  __typename: 'PlaybackOptions';
  audioTracks: Array<AudioTrackOption>;
  subtitleTracks: Array<SubtitleTrack>;
  videoRenditions: Array<VideoRenditionOption>;
};

export type PlaybackUrlInput = {
  audioRenditionId: Scalars['String']['input'];
  audioStreamIndex: Scalars['Int']['input'];
  fileId: Scalars['String']['input'];
  playerId: Scalars['String']['input'];
  videoRenditionId: Scalars['String']['input'];
};

export type PlaybackUrlPayload = {
  __typename: 'PlaybackUrlPayload';
  packagerId: Scalars['String']['output'];
...
export type SubtitleRendition = {
  __typename: 'SubtitleRendition';
  codecName: Scalars['String']['output'];
  displayInfo: Scalars['String']['output'];
  id: Scalars['String']['output'];
  onDemand: Scalars['Boolean']['output'];
  type: SubtitleRenditionType;
};

export enum SubtitleRenditionType {
  Converted = 'CONVERTED',
  Direct = 'DIRECT',
  Generated = 'GENERATED',
  Ocr = 'OCR'
...
export type SubtitleTrack = {
  ...
  id: Scalars['String']['output'];
  languageBcp47: Maybe<Scalars['String']['output']>;
  renditions: Array<SubtitleRendition>;
  streamIndex: Scalars['Int']['output'];
};

export type SubtitleUrlInput = {
  fileId: Scalars['String']['input'];
...
export type SubtitleUrlPayload = {
  __typename: 'SubtitleUrlPayload';
  url: Scalars['String']['output'];
};
...
export type VideoRenditionOption = {
  __typename: 'VideoRenditionOption';
  codecTag: Scalars['String']['output'];
  displayInfo: Scalars['String']['output'];
  displayName: Scalars['String']['output'];
  onDemand: Scalars['Boolean']['output'];
...
export type WatchSessionPlayer = {
  ...
  displayUsername: Scalars['String']['output'];
  id: Scalars['String']['output'];
...
export type CollectionShelfFragment = { __typename: 'Collection', id: string, name: string, itemCount: number, nodeList: { __typename: 'NodeConnection', nodes: Array<(
      { __typename: 'Node', id: string }
      & { ' $fragmentRefs'?: { 'NodePosterFragment': NodePosterFragment } }
    )>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean } } } & { ' $fragmentName'?: 'CollectionShelfFragment' };
...
export type EpisodeCardFragment = (
  { __typename: 'Node', id: string, inWatchlist: boolean, unavailableAt: number | null, properties: { __typename: 'NodeProperties', displayName: string, description: string | null, seasonNumber: number | null, episodeNumber: number | null, firstAired: number | null, thumbnailImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null }, defaultFile: { __typename: 'File', id: string, probe: { __typename: 'FileProbe', runtimeMinutes: number | null } | null } | null, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean, updatedAt: number } | null }
...
export type NodePosterFragment = (
  { __typename: 'Node', id: string, kind: NodeKind, libraryId: string, inWatchlist: boolean, unavailableAt: number | null, unplayedCount: number | null, seasonCount: number, episodeCount: number, seasonNumber: number | null, episodeNumber: number | null, properties: { __typename: 'NodeProperties', displayName: string, displayDetail: string | null, firstAired: number | null, lastAired: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null }, currentPlayable: { __typename: 'Node', id: string, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean, updatedAt: number } | null } | null }
  & { ' $fragmentRefs'?: { 'GetPathForNodeFragment': GetPathForNodeFragment } }
) & { ' $fragmentName'?: 'NodePosterFragment' };

export type PlayerItemCardFragment = { __typename: 'Node', id: string, properties: { __typename: 'NodeProperties', displayName: string, description: string | null, seasonNumber: number | null, episodeNumber: number | null, thumbnailImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null } } & { ' $fragmentName'?: 'PlayerItemCardFragment' };

export type PlayerNavigationFragment = (
  { __typename: 'Node', id: string }
  & { ' $fragmentRefs'?: { 'PlayerItemCardFragment': PlayerItemCardFragment } }
) & { ' $fragmentName'?: 'PlayerNavigationFragment' };

export type PlayerMetadataFragment = (
  { __typename: 'Node', id: string, libraryId: string, root: { __typename: 'Node', id: string, libraryId: string, properties: { __typename: 'NodeProperties', displayName: string } } | null, properties: { __typename: 'NodeProperties', displayName: string, seasonNumber: number | null, episodeNumber: number | null, firstAired: number | null, lastAired: number | null } }
  & { ' $fragmentRefs'?: { 'GetPathForNodeFragment': GetPathForNodeFragment } }
) & { ' $fragmentName'?: 'PlayerMetadataFragment' };
...
export type DisabledSubtitlesHintMutationVariables = Exact<{
  input: DisabledSubtitlesHintInput;
}>;


export type DisabledSubtitlesHintMutation = { disabledSubtitlesHint: boolean };

export type PlayerSkipIntroFragment = { __typename: 'Node', id: string, defaultFile: { __typename: 'File', segments: Array<{ __typename: 'FileSegment', kind: FileSegmentKind, startMs: number, endMs: number }>, probe: { __typename: 'FileProbe', runtimeMinutes: number | null } | null } | null, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean } | null } & { ' $fragmentName'?: 'PlayerSkipIntroFragment' };

export type MintSubtitleUrlMutationVariables = Exact<{
  input: SubtitleUrlInput;
}>;


export type MintSubtitleUrlMutation = { mintSubtitleUrl: { __typename: 'SubtitleUrlPayload', url: string } };

export type PlayerUpNextFragment = { __typename: 'Node', id: string, defaultFile: { __typename: 'File', id: string, probe: { __typename: 'FileProbe', runtimeMinutes: number | null } | null } | null, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean } | null, nextPlayable: (
    { __typename: 'Node', id: string }
    & { ' $fragmentRefs'?: { 'PlayerItemCardFragment': PlayerItemCardFragment } }
  ) | null } & { ' $fragmentName'?: 'PlayerUpNextFragment' };

export type WatchSessionBeaconFragmentFragment = { __typename: 'WatchSessionBeacon', sessionId: string, nodeId: string, fileId: string, mode: WatchSessionMode, intent: WatchSessionIntent, effectiveState: EffectiveWatchSessionState, basePositionMs: number, baseTimeMs: number, revision: number, players: Array<{ __typename: 'WatchSessionPlayer', id: string, userId: string, displayUsername: string, isBuffering: boolean, isInactive: boolean, canRemove: boolean }> } & { ' $fragmentName'?: 'WatchSessionBeaconFragmentFragment' };
...
export type MintPlaybackUrlMutationVariables = Exact<{
  input: PlaybackUrlInput;
}>;


export type MintPlaybackUrlMutation = { mintPlaybackUrl: { __typename: 'PlaybackUrlPayload', url: string, packagerId: string } };
...
export type ItemPlaybackQueryVariables = Exact<{
  ...
  languageHints?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
}>;


export type ItemPlaybackQuery = { node: (
    { __typename: 'Node', id: string, defaultFile: { __typename: 'File', id: string, probe: { __typename: 'FileProbe', runtimeMinutes: number | null } | null, playbackOptions: { __typename: 'PlaybackOptions', videoRenditions: Array<{ __typename: 'VideoRenditionOption', renditionId: string, displayName: string, displayInfo: string, codecTag: string, onDemand: boolean }>, audioTracks: Array<{ __typename: 'AudioTrackOption', streamIndex: number, displayName: string, language: string | null, recommended: boolean, renditions: Array<{ __typename: 'AudioRenditionOption', renditionId: string, codecName: string, bitrate: number | null, channels: number | null, sampleRate: number | null, codecTag: string, onDemand: boolean }> }>, subtitleTracks: Array<{ __typename: 'SubtitleTrack', id: string, streamIndex: number, displayName: string, languageBcp47: string | null, flags: Array<string>, autoselect: boolean, renditions: Array<{ __typename: 'SubtitleRendition', id: string, codecName: string, type: SubtitleRenditionType, displayInfo: string, onDemand: boolean }> }> }, timelinePreview: Array<(
        { __typename: 'TimelinePreviewSheet' }
        & { ' $fragmentRefs'?: { 'PlayerTimelinePreviewSheetFragment': PlayerTimelinePreviewSheetFragment } }
      )> } | null, previousPlayable: (
      { __typename: 'Node', id: string }
      & { ' $fragmentRefs'?: { 'PlayerNavigationFragment': PlayerNavigationFragment } }
    ) | null, nextPlayable: (
      { __typename: 'Node', id: string }
      & { ' $fragmentRefs'?: { 'PlayerNavigationFragment': PlayerNavigationFragment } }
    ) | null, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean, updatedAt: number } | null }
    & { ' $fragmentRefs'?: { 'PlayerMetadataFragment': PlayerMetadataFragment;'PlayerSkipIntroFragment': PlayerSkipIntroFragment;'PlayerUpNextFragment': PlayerUpNextFragment } }
  ) };
...
export type GetWatchSessionQuery = { watchSession: { __typename: 'WatchSession', id: string, nodeId: string } | null };

export type SearchNodeResultFragment = (
  { __typename: 'Node', id: string, kind: NodeKind, libraryId: string, seasonCount: number, episodeCount: number, root: { __typename: 'Node', properties: { __typename: 'NodeProperties', displayName: string } } | null, properties: { __typename: 'NodeProperties', displayName: string, description: string | null, seasonNumber: number | null, episodeNumber: number | null, firstAired: number | null, lastAired: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null, thumbnailImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null }, defaultFile: { __typename: 'File', id: string, probe: { __typename: 'FileProbe', runtimeMinutes: number | null } | null } | null }
  & { ' $fragmentRefs'?: { 'GetPathForNodeFragment': GetPathForNodeFragment } }
...
export type SessionCardFragment = { __typename: 'WatchSession', id: string, updatedAt: number, currentPositionMs: number, effectiveState: EffectiveWatchSessionState, players: Array<{ __typename: 'WatchSessionPlayer', id: string, userId: string, displayUsername: string, user: { __typename: 'User', id: string, createdAt: number } | null }>, node: { __typename: 'Node', id: string, libraryId: string, properties: { __typename: 'NodeProperties', displayName: string, seasonNumber: number | null, episodeNumber: number | null, firstAired: number | null, lastAired: number | null, posterImage: (
        { __typename: 'Asset' }
        & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
      ) | null, thumbnailImage: (
        { __typename: 'Asset' }
        & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
      ) | null }, defaultFile: { __typename: 'File', id: string, probe: { __typename: 'FileProbe', runtimeMinutes: number | null } | null } | null, root: { __typename: 'Node', id: string, properties: { __typename: 'NodeProperties', displayName: string, posterImage: (
          { __typename: 'Asset' }
          & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
...
export type SidebarNavigationQuery = { libraries: Array<{ __typename: 'Library', id: string, name: string, createdAt: number, pinned: boolean }>, collections: Array<{ __typename: 'Collection', id: string, name: string, createdById: string | null }> };
...
export type AddNodeToWatchlistMutationVariables = Exact<{
  nodeId: Scalars['String']['input'];
}>;


export type AddNodeToWatchlistMutation = { addNodeToWatchlist: boolean };

export type RemoveNodeFromWatchlistMutationVariables = Exact<{
  nodeId: Scalars['String']['input'];
}>;


export type RemoveNodeFromWatchlistMutation = { removeNodeFromWatchlist: boolean };
...
export type GetNodeByIdQuery = { node: (
    { __typename: 'Node', id: string, kind: NodeKind, inWatchlist: boolean, unavailableAt: number | null, unplayedCount: number | null, seasonCount: number, seasonNumber: number | null, episodeNumber: number | null, parent: (
      ...
      & { ' $fragmentRefs'?: { 'GetPathForNodeFragment': GetPathForNodeFragment } }
    ) | null, properties: { __typename: 'NodeProperties', displayName: string, tagline: string | null, description: string | null, posterImage: (
        { __typename: 'Asset' }
        & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
      ) | null, thumbnailImage: (
        { __typename: 'Asset' }
        ...
        & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
            ...
            { __typename: 'Asset' }
            & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
          ) | null } }> }, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean, updatedAt: number } | null, currentPlayable: { __typename: 'Node', id: string, seasonNumber: number | null, episodeNumber: number | null, watchProgress: { __typename: 'WatchProgress', id: string, progressPercent: number, completed: boolean, updatedAt: number } | null } | null, defaultFile: { __typename: 'File', id: string, probe: { __typename: 'FileProbe', runtimeMinutes: number | null, width: number | null, height: number | null, videoCodec: string | null, videoBitrate: number | null } | null, subtitles: Array<{ __typename: 'SubtitleTrack', displayName: string, languageBcp47: string | null }> } | null, recommendedNodes: Array<(
      { __typename: 'Node', id: string }
      & { ' $fragmentRefs'?: { 'NodePosterFragment': NodePosterFragment } }
    )> }
    & { ' $fragmentRefs'?: { 'GetPathForNodeFragment': GetPathForNodeFragment } }
...
export const DisabledSubtitlesHintDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DisabledSubtitlesHint"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DisabledSubtitlesHintInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"disabledSubtitlesHint"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<DisabledSubtitlesHintMutation, DisabledSubtitlesHintMutationVariables>;
export const MintSubtitleUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MintSubtitleUrl"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SubtitleUrlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mintSubtitleUrl"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}}]} as unknown as DocumentNode<MintSubtitleUrlMutation, MintSubtitleUrlMutationVariables>;
...
export const MintPlaybackUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MintPlaybackUrl"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PlaybackUrlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mintPlaybackUrl"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"packagerId"}}]}}]}}]} as unknown as DocumentNode<MintPlaybackUrlMutation, MintPlaybackUrlMutationVariables>;
...
export const ItemPlaybackDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ItemPlayback"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"itemId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"languageHints"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"nodeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"itemId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerMetadata"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerSkipIntro"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerUpNext"}},{"kind":"Field","name":{"kind":"Name","value":"defaultFile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"probe"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"runtimeMinutes"}}]}},{"kind":"Field","name":{"kind":"Name","value":"playbackOptions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"languageHints"},"value":{"kind":"Variable","name":{"kind":"Name","value":"languageHints"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"videoRenditions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"renditionId"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"displayInfo"}},{"kind":"Field","name":{"kind":"Name","value":"codecTag"}},{"kind":"Field","name":{"kind":"Name","value":"onDemand"}}]}},{"kind":"Field","name":{"kind":"Name","value":"audioTracks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"streamIndex"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"language"}},{"kind":"Field","name":{"kind":"Name","value":"recommended"}},{"kind":"Field","name":{"kind":"Name","value":"renditions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"renditionId"}},{"kind":"Field","name":{"kind":"Name","value":"codecName"}},{"kind":"Field","name":{"kind":"Name","value":"bitrate"}},{"kind":"Field","name":{"kind":"Name","value":"channels"}},{"kind":"Field","name":{"kind":"Name","value":"sampleRate"}},{"kind":"Field","name":{"kind":"Name","value":"codecTag"}},{"kind":"Field","name":{"kind":"Name","value":"onDemand"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"subtitleTracks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"streamIndex"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"languageBcp47"}},{"kind":"Field","name":{"kind":"Name","value":"flags"}},{"kind":"Field","name":{"kind":"Name","value":"autoselect"}},{"kind":"Field","name":{"kind":"Name","value":"renditions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"codecName"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"displayInfo"}},{"kind":"Field","name":{"kind":"Name","value":"onDemand"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"timelinePreview"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerTimelinePreviewSheet"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"previousPlayable"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerNavigation"}}]}},{"kind":"Field","name":{"kind":"Name","value":"nextPlayable"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerNavigation"}}]}},{"kind":"Field","name":{"kind":"Name","value":"watchProgress"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"progressPercent"}},{"kind":"Field","name":{"kind":"Name","value":"completed"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"GetPathForNode"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Node"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"libraryId"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ImageAsset"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Asset"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"signedUrl"}},{"kind":"Field","name":{"kind":"Name","value":"thumbhash"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PlayerItemCard"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Node"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"properties"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"thumbnailImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ImageAsset"}}]}},{"kind":"Field","name":{"kind":"Name","value":"seasonNumber"}},{"kind":"Field","name":{"kind":"Name","value":"episodeNumber"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PlayerMetadata"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Node"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"libraryId"}},{"kind":"Field","name":{"kind":"Name","value":"root"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"libraryId"}},{"kind":"Field","name":{"kind":"Name","value":"properties"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"properties"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"seasonNumber"}},{"kind":"Field","name":{"kind":"Name","value":"episodeNumber"}},{"kind":"Field","name":{"kind":"Name","value":"firstAired"}},{"kind":"Field","name":{"kind":"Name","value":"lastAired"}}]}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"GetPathForNode"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PlayerSkipIntro"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Node"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"defaultFile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"segments"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"startMs"}},{"kind":"Field","name":{"kind":"Name","value":"endMs"}}]}},{"kind":"Field","name":{"kind":"Name","value":"probe"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"runtimeMinutes"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"watchProgress"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"progressPercent"}},{"kind":"Field","name":{"kind":"Name","value":"completed"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PlayerUpNext"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Node"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"defaultFile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"probe"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"runtimeMinutes"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"watchProgress"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"progressPercent"}},{"kind":"Field","name":{"kind":"Name","value":"completed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"nextPlayable"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerItemCard"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PlayerTimelinePreviewSheet"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TimelinePreviewSheet"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"positionMs"}},{"kind":"Field","name":{"kind":"Name","value":"endMs"}},{"kind":"Field","name":{"kind":"Name","value":"sheetIntervalMs"}},{"kind":"Field","name":{"kind":"Name","value":"sheetGapSize"}},{"kind":"Field","name":{"kind":"Name","value":"asset"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"signedUrl"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PlayerNavigation"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Node"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlayerItemCard"}}]}}]} as unknown as DocumentNode<ItemPlaybackQuery, ItemPlaybackQueryVariables>;
export const GetWatchSessionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetWatchSession"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"watchSession"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"sessionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"nodeId"}}]}}]}}]} as unknown as DocumentNode<GetWatchSessionQuery, GetWatchSessionQueryVariables>;
...
export const AddNodeToWatchlistDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddNodeToWatchlist"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"nodeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addNodeToWatchlist"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"nodeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"nodeId"}}}]}]}}]} as unknown as DocumentNode<AddNodeToWatchlistMutation, AddNodeToWatchlistMutationVariables>;
export const RemoveNodeFromWatchlistDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveNodeFromWatchlist"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"nodeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeNodeFromWatchlist"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"nodeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"nodeId"}}}]}]}}]} as unknown as DocumentNode<RemoveNodeFromWatchlistMutation, RemoveNodeFromWatchlistMutationVariables>;
