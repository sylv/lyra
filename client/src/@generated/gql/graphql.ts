...
export type NodePosterFragment = (
  { __typename: 'Node', id: string, kind: NodeKind, libraryId: string, unavailableAt: number | null, unplayedCount: number, seasonCount: number, episodeCount: number, properties: { __typename: 'NodeProperties', displayName: string, firstAired: number | null, lastAired: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
...
export type SeasonCardFragment = (
  { __typename: 'Node', id: string, unavailableAt: number | null, unplayedCount: number, episodeCount: number, properties: { __typename: 'NodeProperties', displayName: string, seasonNumber: number | null, firstAired: number | null, lastAired: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
    ) | null, thumbnailImage: (
      { __typename: 'Asset' }
...
export type GetNodeByIdQuery = { node: (
    { __typename: 'Node', id: string, libraryId: string, kind: NodeKind, unavailableAt: number | null, seasonNumber: number | null, episodeNumber: number | null, unplayedCount: number, episodeCount: number, parent: (
