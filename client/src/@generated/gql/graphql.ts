...
export type ImageAssetFragment = { __typename: 'Asset', id: string, thumbhash: string | null } & { ' $fragmentName'?: 'ImageAssetFragment' };
...
export type GetLibrariesQuery = { libraries: Array<{ __typename: 'Library', id: string, name: string, path: string, lastScannedAt: number | null }> };
...
export type CreateLibraryMutation = { createLibrary: { __typename: 'Library', id: string, name: string, path: string, lastScannedAt: number | null } };
...
export type UpdateLibraryMutation = { updateLibrary: { __typename: 'Library', id: string, name: string, path: string, lastScannedAt: number | null } };
...
export type UsersManagementQuery = { viewer: { __typename: 'User', id: string } | null, users: Array<{ __typename: 'User', id: string, username: string, inviteCode: string | null, permissions: number, lastSeenAt: number | null }> };
...
export type CreateUserInviteMutation = { createUserInvite: { __typename: 'User', id: string, username: string, inviteCode: string | null, permissions: number, lastSeenAt: number | null } };
...
export type UpdateUserMutation = { updateUser: { __typename: 'User', id: string, username: string, inviteCode: string | null, permissions: number, lastSeenAt: number | null } };
...
export type ResetUserInviteMutation = { resetUserInvite: { __typename: 'User', id: string, username: string, inviteCode: string | null, permissions: number, lastSeenAt: number | null } };
...
export type GetAllMediaQuery = { nodeList: { __typename: 'NodeConnection', edges: Array<{ __typename: 'NodeEdge', node: (
        { __typename: 'Node' }
...
export type GetLibraryMediaQuery = { nodeList: { __typename: 'NodeConnection', edges: Array<{ __typename: 'NodeEdge', node: (
        { __typename: 'Node', id: string }
        & { ' $fragmentRefs'?: { 'MediaListFragment': MediaListFragment } }
