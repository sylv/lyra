...
export type MediaPosterFragment = (
  { __typename: 'Node', id: string, name: string, kind: NodeKind, libraryId: number, unplayedCount: number, seasonCount: number, episodeCount: number, properties: { __typename: 'NodeProperties', releasedAt: number | null, endedAt: number | null, posterImage: (
      { __typename: 'Asset' }
      & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
...
export type GetPathForNodeFragment = { __typename: 'Node', id: string, libraryId: number } & { ' $fragmentName'?: 'GetPathForNodeFragment' };
...
export type GetNodeByIdQuery = { node: { __typename: 'Node', id: string, libraryId: number, kind: NodeKind, name: string, seasonNumber: number | null, episodeNumber: number | null, unplayedCount: number, parent: { __typename: 'Node', id: string, name: string, libraryId: number } | null, children: Array<(
      ...
      & { ' $fragmentRefs'?: { 'SeasonCardFragment': SeasonCardFragment;'EpisodeCardFragment': EpisodeCardFragment } }
        ...
        { __typename: 'Asset' }
        & { ' $fragmentRefs'?: { 'ImageAssetFragment': ImageAssetFragment } }
      ) | null }, nextPlayable: { __typename: 'Node', id: string, watchProgress: { __typename: 'WatchProgress', progressPercent: number, completed: boolean, updatedAt: number } | null } | null, previousPlayable: { __typename: 'Node', id: string } | null } };
