...
export type GetNodeByIdQuery = { node: { __typename: 'Node', id: string, libraryId: number, kind: NodeKind, name: string, seasonNumber: number | null, episodeNumber: number | null, unplayedCount: number, parent: { __typename: 'Node', id: string, name: string, libraryId: number } | null, root: { __typename: 'Node', id: string, name: string } | null, children: Array<(
