...
export type GetNodeByIdQuery = { node: { __typename: 'Node', id: string, libraryId: string, kind: NodeKind, name: string, seasonNumber: number | null, episodeNumber: number | null, unplayedCount: number, episodeCount: number, parent: { __typename: 'Node', id: string, name: string, libraryId: string } | null, root: { __typename: 'Node', id: string, name: string } | null, children: Array<(
