...
export const TabsList: FC<TabsListProps> = ({ className, variant = "default", ...props }) => {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:border-input data-[state=active]:bg-input/30 data-[state=active]:text-foreground",
